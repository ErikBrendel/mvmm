...
for view in ALL_VIEWS:
    ...
    override_max = {"references": 65, "evolutionary": 100}.get(view, None)
    show_multi_histogram(all_node_degrees, f"Weighted Node Degrees in the {view} graphs", xlabel="Weighted Node Degree", ylog=True, show=False, override_max=override_max)
