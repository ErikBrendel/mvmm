...
for repo in repos:
    ...
    for view in ["references", "evolutionary", "linguistic"]:  # ["references", "evolutionary", "linguistic"]
        # MetricManager.clear(r, view)

        coupling_graph = MetricManager.get(r, view, ignore_post_processing=True)
    ...
    for node_filter_mode in ALL_NODE_FILTER_MODES:
        ...
        ], node_filter_mode, parallel=False, ignore_previous_results=True)
